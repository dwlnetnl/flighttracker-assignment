## Senior Software Engineer Take-Home Programming Assignment for Go
...
- Create a private GitHub repo and add *[redacted]* as collaborator to the project. *Please only add the collaborators when you are sure you are finished.*

- Define and document the format of the API endpoint in the README.

- Use Go and/or any tools that you think will help you best accomplish the task at hand.
